...
pblob = bytes()
for noteindex in range(10):
    # note on
    pblob += cbox.Pattern.serialize_event(noteindex * 24, 0x90, 36, 127)
    # note off
    pblob += cbox.Pattern.serialize_event(noteindex * 24 + 23, 0x90, 36, 0)
...
cbox.do_cmd("/master/set_tempo", None, [120.0])
# Start playback
