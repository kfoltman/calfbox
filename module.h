...
struct cbox_module_manifest
{
    ...
    struct cbox_module *(*create)(void *user_data, const char *cfg_section, struct cbox_document *doc, struct cbox_rt *rt, GError **error);
};
...
extern struct cbox_module *cbox_module_manifest_create_module(struct cbox_module_manifest *manifest, const char *cfg_section, struct cbox_document *doc, struct cbox_rt *rt, const char *instance_name, GError **error);

extern struct cbox_module *cbox_module_new_from_fx_preset(const char *name, struct cbox_document *doc, struct cbox_rt *rt, GError **error);

extern void cbox_module_init(struct cbox_module *module, struct cbox_document *doc, struct cbox_rt *rt, void *user_data, int inputs, int outputs, cbox_process_cmd cmd_handler, void (*destroy)(struct cbox_module *module));
extern void cbox_module_swap_pointers_and_free(struct cbox_module *sm, void **pptr, void *value);

extern gboolean cbox_module_slot_process_cmd(struct cbox_module **psm, struct cbox_command_target *fb, struct cbox_osc_command *cmd, const char *subcmd, struct cbox_document *doc, struct cbox_rt *rt, GError **error);
...
#define MODULE_CREATE_FUNCTION(module) \
    struct cbox_module *module##_create(void *user_data, const char *cfg_section, struct cbox_document *doc, struct cbox_rt *rt, GError **error)
...
#define CALL_MODULE_INIT(m, inputs, outputs, name) \
    cbox_module_init(&(m)->module, doc, rt, (m), inputs, outputs, name##_process_cmd, name##_destroyfunc);

#define CALL_MODULE_INIT_SIMPLE(m, inputs, outputs) \
    cbox_module_init(&(m)->module, doc, rt, (m), inputs, outputs, NULL, NULL);
